        ...
        success: function(data){
       	 ...
       	 if(data!=null){	
	        	...
	        	for(var i=0;i<data.AllInfo.length;i++){
	        		...
	        		if(type==1){
	        			$(".content").append(textHtml(getuuid(),dailyID,userName,userImg,content,releaseTime,loved,userID));	
	        		}
	        		else if(type==2){
			        	var imgsrc=data.AllInfo[i].url;
			        	$(".content").append(picture(getuuid(),dailyID,userName,userImg,imgsrc,content,releaseTime,loved,userID));	
	        		}
	        		else if(type==3){
	        			var title=data.AllInfo[i].title;
	        			$(".content").append(article(getuuid(),dailyID,userName,userImg,content,releaseTime,title,loved,userID));	
	        		}
	        		offsetNumber+=1;
	        		getlast=0;
	        	}
