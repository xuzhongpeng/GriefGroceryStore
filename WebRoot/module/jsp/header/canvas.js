$(function(){
	var canvasStyle=document.getElementById("canvas");
	canvasStyle.setAttribute('style', 'position:absolute;    width:100%;	height:100%;	z-index: -1;');
...
/*	window.onresize = function(){
	 ...
	 window.addEventListener("scroll", function(event) {
	 	can.width = window.innerWidth;
		can.height = 600;
		console.log(document.documentElement.scrollHeight+","+window.innerWidth+","+window.innerHeight);
	 })
...
can.width = window.innerWidth;
can.height = document.documentElement.scrollHeight;
cxt.lineWidth = 0.3;
//初始链接线条显示位置
var mousePosition = {
 x : 30*can.width/100,
