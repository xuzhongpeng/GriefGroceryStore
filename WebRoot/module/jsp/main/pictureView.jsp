...
<html>
  <head>
    ...
    <title>My JSP 'pictureView.jsp' starting page</title>
	...
	<link rel="stylesheet" type="text/css" href="module/css/pictureView/pictureView.css">
	...
	<script src="module/js/main/pictureView.js" type="text/javascript" charset="utf-8" ></script>
</head>
<style>
#alertImg:hover{
...
<body>
	...
	<div class="center" style="background-color:#eaeaea">
		<div class="col">
