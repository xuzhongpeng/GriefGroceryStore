...
<html>
  <head>
	...
	<script src="module/js/main/personalInformation.js" type="text/javascript" charset="utf-8" ></script>
                            ...
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="button" id='puOn' class="am-btn am-btn-primary tpl-btn-bg-color-success" style="height:45px;font-size:18px;">提交</button>
                                    </div>
                                </div>
                            </form>
