...
<html>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="display:none" class="table-title">用户id</th>
                                            <th class="table-type">发布类型</th>
                                            <th class="table-author">标题</th>
                                            <th class="table-date">内容</th>
                                            <th class="table-type">图片id</th>
  ...
  <script  type="text/javascript"  charset="utf-8" src="backstage/assets/js/jquery.min.js"></script>
   ...
   <script  type="text/javascript"  charset="utf-8" src="backstage/assets/js/userManage/dailyManage.js"></script>
