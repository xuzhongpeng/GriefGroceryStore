...
<html>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">dailyID</th>
                                            <th class="table-type">被评论人</th>
                                            <th class="table-author">评论内容</th>
                                            <th class="table-date">评论时间</th>
  ...
  <script  type="text/javascript"  charset="utf-8" src="backstage/assets/js/jquery.min.js"></script>
   ...
   <script  type="text/javascript"  charset="utf-8" src="backstage/assets/js/userManage/comment.js"></script>
